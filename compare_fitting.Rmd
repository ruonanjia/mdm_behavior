...
val_plot_re <- rbind(val_plot2[,c(6,5,1,7,11,15)],val_plot2[,c(6,5,2,8,12,16)],
                   val_plot2[,c(6,5,3,9,13,17)],val_plot2[,c(6,5,4,10,14,18)])
...
val_start2plot = 100
ggplot(val_plot_re[val_plot_re$val_start == val_start2plot,], aes(x=val_med, fill = level, color = level)) +
...
```{r}
monpar_plot <- data.frame('r2_10' = fit1$r2_adj_mon,'r2_50'= fit2$r2_adj_mon, 'r2_100' = fit3$r2_adj_mon)
medpar_plot <- data.frame('r2_10' = fit1$r2_adj_med,'r2_50'= fit2$r2_adj_med, 'r2_100' = fit3$r2_adj_med)
...
beta
```{r}
monpar_plot <- data.frame('beta_10' = fit1$beta_mon,'beta_50'= fit2$beta_mon, 'beta_100' = fit3$beta_mon)
medpar_plot <- data.frame('beta_10' = fit1$beta_med,'beta_50'= fit2$beta_med, 'beta_100' = fit3$beta_med)
